...
#define DAOS_PO_QUERY_PROP_PERF_DOMAIN	(1ULL << (PROP_BIT_START + 13))
#define DAOS_PO_QUERY_PROP_BIT_END	29
...
#define DAOS_PO_QUERY_PROP_ALL						\
	(DAOS_PO_QUERY_PROP_LABEL | DAOS_PO_QUERY_PROP_SPACE_RB |	\
	 ...
	 DAOS_PO_QUERY_PROP_POLICY | DAOS_PO_QUERY_PROP_PERF_DOMAIN)
